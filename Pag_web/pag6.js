...
var map = L.map('map',{ center: [8.37383038282158, -27.550010005249256], zoom: 3, zoomControl: false});
    ...
    PUC.bindTooltip("<h3>Pontifícia Universidade Católica do Rio de Janeiro</h3><img src='./Img/PUC_Logo.jpg'width='150'height='62'/><p><strong>Graduação: </strong>Geografia<p>R. Marquês de São Vicente, 225 - Casa XV<br>Gávea, Rio de Janeiro, 22541-041, Brasil<br><br>-22.97954278, -43.23287030</p>");


    //CMM
    var myDataPoint = L.marker([41.18352209127619, -8.682948346516875]).addTo(map);
    myDataPoint.bindTooltip("<h3>Estágio - Câmara Municipal de Matosinhos</h3><img src='./Img/CMM_MAT2.png'width='230'height='50' <br> <p>Av. Dom Afonso Henriques, 4454-510 Matosinhos - Porto, Portugal</p> 41.18350594, -8.682862515");
    ...
    onEachFeature: function (feature, layer) { 
        ...
        //layer.bindPopup('<h1>' + idp + '</h1> <br> <h2>' + type + ':('+ coord +')'); 
    }})
    .addTo(map);
    ...
    //DISTRITO DE LEIRIA
    var LeiriaDistrito = L.geoJSON(Leiria_Dist,{
        color:'red',
        weight: 1.5,
    onEachFeature: function (feature, layer) { 
        ...
        let type = feature.geometry.type
        let coord = feature.geometry.coordinates
        layer.bindPopup('<h1>Análise Espacial Aplicada ao Ordenamento Territorial do Distrito de Leiria</h1><br><p>Relatório realizado durante o mestrado, no âmbito da unidade curricular de Análise Espacial Aplicada ao Ordenamento do Território, o qual teve como objetivo, desenvolver um diagnóstico dos riscos de incêndios apredentados no distrito. (2020)</p><a href="./Trabalhos/AEOT_Relatorio.pdf" target="_blank"><strong>Abrir Relatório<strong></a>')
        //layer.bindPopup('<h1>' + idp + '</h1> <br> <h2>' + type + ':('+ coord +')'); 
    }})
    .addTo(map);
    ...
    onEachFeature: function (feature, layer) { 
        ...
        let type = feature.geometry.type;
        let coord = feature.geometry.coordinates;
        layer.bindPopup('<h1>Favela: ' + nome + '</h1> <h2>Bairro: ' + bairro + '</h2> <p><strong>Área</strong>: ' + area + ' ha</p><p><strong>Porte</strong>: ' + domicilio + '</p><p><strong>Fonte</strong>: IBGE - Censo Demográfico 2010<br> e Data Rio</p>'); 
        //layer.bindPopup('<h1>' + idp + '</h1> <br> <h2>'+ complex +'</h2> <h2>' + type + ':('+ coord +')'); 
    }})
    .addTo(map);
    ...
    //LAYERS RJ
    var layers = {
        'Alojamento Local - <strong>Matosinhos</strong>': Alojamento,
        'Município - <strong>Matosinhos</strong>': myDataCMM,
        'Município do Rio de Janeiro - <strong>RJ</strong>': MunicipioRJ,
        'Áreas de Favela - <strong>RJ</strong>': Limite_Favelas,
        'Unidades de Polícia Pacificadora (UPP) - <strong>RJ</strong>': UPP,
        'Equipamentos Olímpicos RIO2016- <strong>RJ</strong>': olimpico,
    };
